        ...
        <Container className="py-5">
          <Row className="align-items-center">
            <Col md={6} className="text-center text-md-start mb-4 mb-md-0">
              <h1 className="about-title mb-4">About Hazard World</h1>
              ...
              <p className="about-text">
                To reinforce learning, <strong>Hazard World</strong> integrates quizzes after each chapter, encouraging critical thinking and solidifying understanding of the relationship between human activities and environmental practices.
              </p>
            </Col>
